...
export const TOOL_CONTRACT: ToolContract[] = [
  ...
  {
    name: "tgc_component_update",
    description: "Update a non-deck component in place (for example rename, art swaps, side updates).",
    inputSchema: {
      type: "object",
      properties: {
        componentType: { type: "string" },
      ...
      required: ["componentType", "componentId"],
      additionalProperties: false,
    },
  },
  {
