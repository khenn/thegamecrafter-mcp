...
- `preferences.feedback_contribution` controls whether session feedback mode is enabled.
...
- Keep startup feedback opt-in separate from per-publication approval.
