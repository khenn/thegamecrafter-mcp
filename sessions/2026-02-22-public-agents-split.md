...
## Changes Made
- Added `context/TGCAGENT.md` as a reusable/public behavior profile for TGCMCP agents.
- Updated root `AGENTS.md` to explicitly load `context/TGCAGENT.md`.
- Added precedence rule:
  - root `AGENTS.md` overrides `context/TGCAGENT.md` for local/project-specific conflicts.
