...
## Actions
- Reviewed root `AGENTS.md`, `context/AGENTS.md`, and `skills/tgc-guided-workflows/SKILL.md`.
- Confirmed key end-user behavior and component guidance remains in `context/AGENTS.md` and `skills/tgc-guided-workflows/SKILL.md`.
...
- Updated `context/AGENTS.md` documentation section to require synchronized updates with skill docs when guidance changes.
